...
import be.ehb.javaframeworks.springcore.dao.BlogSquareDaoConfig;
...
@Configuration
@Import(BlogSquareDaoConfig.class)
public class BlogSquare22 {

    @Bean
    BlogService blogService(BlogPostDao blogPostDao, BlogCommentDao blogCommentDao) {
